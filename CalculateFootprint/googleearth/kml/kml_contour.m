function kml_contour(lon, lat, z, filename, varargin)
...
%
% Output:
%     This function creates a kml file called 'filename' in the current
%     working directory
%
...
function kml_begin(kmlfile, labelsize, color, width)
    ...
    fprintf(kmlfile, '	<name>filename</name>\n');
